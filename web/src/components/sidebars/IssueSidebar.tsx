      ...
      {issue.converted_from_id && onUndoConversion && (
        <div className="mb-4 rounded-lg border border-blue-500/30 bg-blue-500/10 p-3">
          ...
          >
            {isUndoing ? (
              <>
                <svg aria-hidden="true" focusable="false" className="w-4 h-4 animate-spin" viewBox="0 0 24 24" fill="none">
              ...
              <>
                <svg aria-hidden="true" focusable="false" className="w-4 h-4" viewBox="0 0 20 20" fill="currentColor">
