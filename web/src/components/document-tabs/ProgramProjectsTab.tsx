    ...
    return (
      <div className="h-full overflow-auto p-4">
        ...
        <div className="flex flex-col items-center justify-center h-48 text-muted">
          <svg aria-hidden="true" focusable="false" className="w-12 h-12 mb-3 opacity-50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <div className="space-y-2">
        {projects.map((project) => (
          ...
          >
            ...
            {/* Arrow */}
            <svg aria-hidden="true" focusable="false" className="w-4 h-4 text-muted flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
